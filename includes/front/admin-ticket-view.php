                                            ...
                                            <div class="panel-body">
                                                ...
                                                <?php if(!empty($ticket_details->ticket->tags)) :
            					            		...
            					            		foreach ($ticket_details->ticket->tags as $tag_key => $tag_value) :
            					            				...
            					            				echo '<div class="btn-group"><a class="btn btn-sm btn-default" href="/en/member/tickets#tag/'.$tag_value->id.'" data-tag-id='.$tag_value->id.'>'.$tag_value->name.'</a><button class="btn btn-sm btn-default delete-tag" type="button"><span class="text-danger fa fa-remove"></span></button></div>';
                                                                ...
                                                                <div class="thread-attachments">
                                                                    ...
                                                                    <div class="attachment">
                                                                        ...
                                                                        <?php foreach ($ticket_details->createThread->attachments as $attchment_key => $attchment_value) :
                                                                            ...
                                                                            $aname=end( $tmp );
                                                                        ?>
                                                                            <a href="<?php echo $attchment_value->attachmentThumb; ?>" target="_blank">
            								    ...
            								    <div class="col-sm-12">
            								        ...
            								        <div class="tab-block form-div">
            								            <div class="ticket-form">
            								                <div class="thread-info-row">
            								                    <a href="#">
            								                        <strong><?php if(isset($ticket_details->ticket->agent->detail->agent->name)) echo $ticket_details->ticket->agent->detail->agent->name; else 'No Agent Assigned';?></strong>
            								                    </a>
            								                </div>
            								            </div>
